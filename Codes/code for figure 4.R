...
data_summer_no_loss <- read_csv(file.choose())
data_summer_no_bush <- read_csv(file.choose())
data_summer_no_rock <- read_csv(file.choose())
data_winter_no_loss <- read_csv(file.choose())
data_winter_no_bush <- read_csv(file.choose())
data_winter_no_rock <- read_csv(file.choose())
